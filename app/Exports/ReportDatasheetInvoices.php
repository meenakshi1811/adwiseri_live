...
class ReportDatasheetInvoices implements FromCollection, WithTitle, WithHeadings
{
    private $data;
    ...
    {
        $invoices = Internal_Invoices::where('subscriber_id', $this->data)->where('status', $this->key)->where('created_at','>=', date("Y-07-01 00:00:00"))->where('created_at','<=',date("Y-07-t 23:59:59"))->get();
