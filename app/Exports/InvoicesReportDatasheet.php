...
class InvoicesReportDatasheet implements FromCollection, WithTitle, WithHeadings
{
    private $data;
    ...
    {
        $invoices = Internal_Invoices::where('subscriber_id', $this->data)->where('status', $this->key)->get();
