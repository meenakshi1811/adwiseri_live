...
class ReportDatasheetApplications implements FromCollection, WithTitle, WithHeadings
{
    private $data;
    ...
    {
        $apps = Applications::where('subscriber_id','=',$this->data)->where('application_name', $this->key)->where('created_at','>=', date("Y-07-01 00:00:00"))->where('created_at','<=',date("Y-07-t 23:59:59"))->get();
