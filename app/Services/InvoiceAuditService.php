...
class InvoiceAuditService
{
    ...
    public function resolveCreatedByDisplay(Internal_Invoices $invoice): string
    {
        ...
        if (!empty($invoice->created_by_name)) {
            return $this->stripStoredNameSuffix($invoice->created_by_name);
        }
    ...
    public function resolveUpdatedByDisplay(Internal_Invoices $invoice): ?string
    {
        ...
        return !empty($invoice->updated_by_name)
            ? $this->stripStoredNameSuffix($invoice->updated_by_name)
            : null;
    }
    ...
    private function stripStoredNameSuffix(string $name): string
    {
        $name = trim($name);
