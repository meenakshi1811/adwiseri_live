...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light text-white shadow-sm" style="background:#695EEE;">
            <div class="container">
                <a class="navbar-brand text-white" href="{{ url('/') }}">
                    <img src="{{ asset('/web_assets/images/Style2.png') }}" width="120px" height="auto" alt="homepage" />
                    <!-- <h2>adwiseri</h2> -->
                </a>
