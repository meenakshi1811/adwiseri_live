...
@endif
    <div class="profile-detail">
        {{-- <div class="col-lg-12 profile-data" style="border: 1px solid lightgrey;"> --}}
            {{-- <div class="row">
            ...
            <div class="profile-detail">
                ...
                <div class="col-lg-4 profile-pic" style="border: 1px solid lightgrey;">
                    ...
                    @if ($affiliateUser->type !== 'Individual')
                        <hr>
                        <div class="row">
                            <div class="col-10"></div>
                            <div class="col-2">
...
<div id="update_box"
    ...
    <div class="row">
        ...
        <div class="col-lg-4 loginouter-box">
            ...
            <form class="details-box login-box" method="POST" action="{{ route('update_user_affiliate') }}">
                @csrf
                ...
                <div class="mb-4">
                    <input name="name" minlength="3" maxlength="100" value="{{ $affiliateUser->name }}" required
                ...
                <div class="mb-4">
                    <input type="text" minlength="3" maxlength="100" value="{{ $affiliateUser->city }}"
...
<div id="change_password"
    ...
    <div class="row">
        ...
        <div class="col-lg-4 loginouter-box">
            ...
            <form class="details-box login-box" method="POST" action="{{ route('change_password_affiliate') }}">
                @csrf
                <input type="hidden" name="local_time" class="localtime" />
