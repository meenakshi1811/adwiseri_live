...
@section('main-section')
            ...
            <div class="client-dashboard">
                ...
                <div class="col">
                    <div class="row px-3">
                        <div class="col-md-4 p-2 border">
                            <label style="font-weight:550;">Affiliate ID</label>
                        </div>
                ...
                <div class="col mb-10">
                    <p style="margin-bottom: 110px;">
                        {{-- Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi illum tempore iure repellat delectus explicabo, fugiat ipsum est sapiente ratione possimus soluta deleniti. Harum aperiam earum minus consequuntur eius at? --}}
                    </p>
            </div>
            @endif
        </div>
  ...
  <script>
      function deleteuser(id){
          var conf = confirm('Are you sure you want to delete this query?');
          if(conf == true){
