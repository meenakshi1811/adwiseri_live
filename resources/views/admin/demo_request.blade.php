                    ...
                    <table class="table table-hover table-bordered fl-table" id="subscriberTable" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">@include('partials.phone_display', ['phone' => $demo->phone])</td>
                                <td class="text-center">{{ $demo->country }}</td>
                                <td class="text-center">{{ $demo->job_title }}</td>
                                <td class="text-center">{{ date("d-m-Y H:i:s", strtotime($demo->created_at)) }}</td>
                                <td class="text-center">{{ date("d-m-Y H:i:s", strtotime($demo->updated_at)) }}</td>
  ...
  @if(session()->has('deleted'))
    <script>
      Swal.fire({
        icon: 'success',
        title: 'Success',
        text: 'Demo request deleted successfully.'
      })
    </script>
