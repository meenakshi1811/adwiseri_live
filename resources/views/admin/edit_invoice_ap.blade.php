            ...
            <div class="invoice-form-card">
                ...
                <form id="registration_form" class="invoice-edit-form" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 p-1">
                            <input name="service_taken" type="text" minlength="2" maxlength="200" required
                                class="form-control @error('service_taken') is-invalid @enderror"
                                value="{{ old('service_taken', $invoice->detail) }}" placeholder="Product/Service Taken">
                            @error('service_taken')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-8 p-1">
                            ...
                            <small class="text-muted d-block mt-1">
                                Default is <strong>0</strong> (tax exempt). Enter your tax rate if applicable, or keep <strong>0</strong>
                                when the client is abroad and the service is treated as an export of services with no tax.
                            </small>
                            @error('tax')
                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                            @enderror
