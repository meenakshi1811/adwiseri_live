        ...
        <div class="col-lg-10 column-client">
            <div class="client-dashboard">
                ...
                <div class="row m-0 pb-2">
                    ...
                    <div class="col-6 border p-1 text-center    text-center tab-anchor top_modules"   onclick="window.location.href = '{{ route('payments') }}';">
                ...
                <div class="table-wrapper">
                    <table class="fl-table table table-hover p-0 m-0" id="clientTable">
                        ...
                        <tr>
                            ...
                            <th class="p-1 text-center">Product/Service Provider</th>
                        ...
                        <tbody>
                         ...
                         @foreach( $paymentAP  as $key=>$payment)
                            <tr>
                               ...
                               <td class="p-1 text-center">{{  $payment->service_provider }} </td>
                               <td class="p-1 text-center">{{ $payment->service_taken}}</td>
