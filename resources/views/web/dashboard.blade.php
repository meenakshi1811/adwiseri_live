          ...
          <div class="col-lg-7 dash-main-col">
            ...
            <div class="data-box">
              <div class="p-4 text-center text-muted">
                ...
                <a href="{{ route('my_settings') }}#dashboard-settings" class="btn btn-sm btn-primary">
                  Choose what to show
                </a>
              </div>
            </div>
        ...
        <div class="col-lg-3 activity-box">
          ...
          <div class="doc-files">
            ...
            <div class="p-docbox d-flex align-items-start">
                ...
                <p>{{ activity_panel_label($activity) }} <br> <span>{{ date("D M d Y H:i:s",strtotime($activity->created_at))}}</span> </p>
            </div>
            @endforeach
