@php
    $auditService = app(\App\Services\InvoiceAuditService::class);
    $createdByDisplay = $auditService->resolveCreatedByDisplay($invoice);
    $updatedByDisplay = $auditService->resolveUpdatedByDisplay($invoice);
@endphp
        ...
        <div class="col-md-6">
            <div class="audit-card audit-created">
                ...
                <div>
                    ...
                    <div class="audit-value">{{ $createdByDisplay }}</div>
        ...
        <div class="col-md-6">
            <div class="audit-card audit-updated">
                ...
                <div>
                    ...
                    <div class="audit-value">{{ $updatedByDisplay ?? 'Not yet updated' }}</div>
                    @if(!empty($updatedByDisplay) && !empty($invoice->updated_at))
...
<style>
    ...
    /* Override global .column-client a { background: #695EEE } */
    ...
    .column-client .invoice-form-card a.invoice-pdf-view-btn {
        ...
        border: 1px solid #695EEE !important;
    ...
    .column-client .invoice-payment-options .payment-link-text,
    .column-client .invoice-box .payment-link-text {
        color: #212529 !important;
